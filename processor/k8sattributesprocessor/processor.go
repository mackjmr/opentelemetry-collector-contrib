...
type kubernetesprocessor struct {
	...
	kubeletPodCfg          *kube.KubeletPodSourceConfig
}
...
func (kp *kubernetesprocessor) initKubeClient(set component.TelemetrySettings, kubeClient kube.ClientProvider) error {
	...
	if !kp.passthroughMode {
		kc, err := kubeClient(set, kp.apiConfig, kp.rules, kp.filters, kp.podAssociations, kp.podIgnore, nil, kube.InformersFactoryList{}, kp.waitForMetadata, kp.waitForMetadataTimeout, kp.watchSyncPeriod, kp.podDeleteGracePeriod, kp.kubeletPodCfg)
		if err != nil {
			return err
		}
		kp.kc = kc
